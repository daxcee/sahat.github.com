...
*[** Source Code](https://github.com/sahat/tvshow-tracker)*
...
Copy all glyphicons from *vendor/assets/fonts/bootstrap* to **public/fonts** directory and **bootstrap** from *vendor/assets/stylesheets* directory to **public/stylesheets** directory.

![](/images/blog/tvshow-tracker-5.png)

Download [this favicon](http://i.imgur.com/A38jRib.png) and place it inside **public** directory. You don't really need it but it’s a nice touch.
...
Create a new file **home.html** in **public/views** directory. This will be a
...
directory except for `app.min.js` or any files in the **vendor**
directory.
...
This task will create a file `templates.js` in the **public** directory
